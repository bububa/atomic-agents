...
replace github.com/sashabaranov/go-openai => github.com/bububa/go-openai v1.0.2
...
require (
	...
	github.com/bububa/instructor-go v1.4.0
	...
	github.com/fumiama/go-docx v0.0.0-20250423091213-bcb49d9c6254
