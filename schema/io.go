...
type Input struct {
	...
	ChatMessage string `json:"chat_message" yaml:"ChatMessage" jsonschema:"title=chat_message,description=The chat message sent by the user to the assistant."`
}
...
type Output struct {
	...
	ChatMessage string `json:"chat_message" yaml:"ChatMessage" jsonschema:"title=chat_message,description=The chat message exchanged between the user and the chat agent.This contains the markdown-enabled response generated by the chat agent."`
}
